...
_lib.Z3_mk_finite_set_sort.restype = Sort
_lib.Z3_mk_finite_set_sort.argtypes = [ContextObj, Sort]
_lib.Z3_is_finite_set_sort.restype = ctypes.c_bool
_lib.Z3_is_finite_set_sort.argtypes = [ContextObj, Sort]
_lib.Z3_get_finite_set_sort_basis.restype = Sort
_lib.Z3_get_finite_set_sort_basis.argtypes = [ContextObj, Sort]
_lib.Z3_mk_finite_set_empty.restype = Ast
_lib.Z3_mk_finite_set_empty.argtypes = [ContextObj, Sort]
_lib.Z3_mk_finite_set_singleton.restype = Ast
_lib.Z3_mk_finite_set_singleton.argtypes = [ContextObj, Ast]
_lib.Z3_mk_finite_set_union.restype = Ast
_lib.Z3_mk_finite_set_union.argtypes = [ContextObj, Ast, Ast]
_lib.Z3_mk_finite_set_intersect.restype = Ast
_lib.Z3_mk_finite_set_intersect.argtypes = [ContextObj, Ast, Ast]
_lib.Z3_mk_finite_set_difference.restype = Ast
_lib.Z3_mk_finite_set_difference.argtypes = [ContextObj, Ast, Ast]
_lib.Z3_mk_finite_set_member.restype = Ast
_lib.Z3_mk_finite_set_member.argtypes = [ContextObj, Ast, Ast]
_lib.Z3_mk_finite_set_size.restype = Ast
_lib.Z3_mk_finite_set_size.argtypes = [ContextObj, Ast]
_lib.Z3_mk_finite_set_subset.restype = Ast
_lib.Z3_mk_finite_set_subset.argtypes = [ContextObj, Ast, Ast]
_lib.Z3_mk_finite_set_map.restype = Ast
_lib.Z3_mk_finite_set_map.argtypes = [ContextObj, Ast, Ast]
_lib.Z3_mk_finite_set_filter.restype = Ast
_lib.Z3_mk_finite_set_filter.argtypes = [ContextObj, Ast, Ast]
_lib.Z3_mk_finite_set_range.restype = Ast
_lib.Z3_mk_finite_set_range.argtypes = [ContextObj, Ast, Ast]
...
_lib.Z3_mk_seq_replace_all.restype = Ast
_lib.Z3_mk_seq_replace_all.argtypes = [ContextObj, Ast, Ast, Ast]
_lib.Z3_mk_seq_replace_re.restype = Ast
_lib.Z3_mk_seq_replace_re.argtypes = [ContextObj, Ast, Ast, Ast]
_lib.Z3_mk_seq_replace_re_all.restype = Ast
_lib.Z3_mk_seq_replace_re_all.argtypes = [ContextObj, Ast, Ast, Ast]
...
_lib.Z3_open_log.restype = ctypes.c_bool
...
_lib.Z3_rcf_interval.argtypes = [ContextObj, RCFNumObj, ctypes.POINTER(ctypes.c_bool), ctypes.POINTER(ctypes.c_bool), ctypes.POINTER(RCFNumObj), ctypes.POINTER(ctypes.c_bool), ctypes.POINTER(ctypes.c_bool), ctypes.POINTER(RCFNumObj)]
...
_lib.Z3_optimize_translate.restype = OptimizeObj
_lib.Z3_optimize_translate.argtypes = [ContextObj, OptimizeObj, ContextObj]
...
_lib.Z3_fpa_is_numeral.restype = ctypes.c_bool
_lib.Z3_fpa_is_numeral.argtypes = [ContextObj, Ast]
...
_lib.Z3_fpa_get_numeral_sign.argtypes = [ContextObj, Ast, ctypes.POINTER(ctypes.c_bool)]
...
def Z3_mk_finite_set_sort(a0, a1, _elems=Elementaries(_lib.Z3_mk_finite_set_sort)):
  r = _elems.f(a0, a1)
  _elems.Check(a0)
  return r

def Z3_is_finite_set_sort(a0, a1, _elems=Elementaries(_lib.Z3_is_finite_set_sort)):
  r = _elems.f(a0, a1)
  _elems.Check(a0)
  return r

def Z3_get_finite_set_sort_basis(a0, a1, _elems=Elementaries(_lib.Z3_get_finite_set_sort_basis)):
  r = _elems.f(a0, a1)
  _elems.Check(a0)
  return r

def Z3_mk_finite_set_empty(a0, a1, _elems=Elementaries(_lib.Z3_mk_finite_set_empty)):
  r = _elems.f(a0, a1)
  _elems.Check(a0)
  return r

def Z3_mk_finite_set_singleton(a0, a1, _elems=Elementaries(_lib.Z3_mk_finite_set_singleton)):
  r = _elems.f(a0, a1)
  _elems.Check(a0)
  return r

def Z3_mk_finite_set_union(a0, a1, a2, _elems=Elementaries(_lib.Z3_mk_finite_set_union)):
  r = _elems.f(a0, a1, a2)
  _elems.Check(a0)
  return r

def Z3_mk_finite_set_intersect(a0, a1, a2, _elems=Elementaries(_lib.Z3_mk_finite_set_intersect)):
  r = _elems.f(a0, a1, a2)
  _elems.Check(a0)
  return r

def Z3_mk_finite_set_difference(a0, a1, a2, _elems=Elementaries(_lib.Z3_mk_finite_set_difference)):
  r = _elems.f(a0, a1, a2)
  _elems.Check(a0)
  return r

def Z3_mk_finite_set_member(a0, a1, a2, _elems=Elementaries(_lib.Z3_mk_finite_set_member)):
  r = _elems.f(a0, a1, a2)
  _elems.Check(a0)
  return r

def Z3_mk_finite_set_size(a0, a1, _elems=Elementaries(_lib.Z3_mk_finite_set_size)):
  r = _elems.f(a0, a1)
  _elems.Check(a0)
  return r

def Z3_mk_finite_set_subset(a0, a1, a2, _elems=Elementaries(_lib.Z3_mk_finite_set_subset)):
  r = _elems.f(a0, a1, a2)
  _elems.Check(a0)
  return r

def Z3_mk_finite_set_map(a0, a1, a2, _elems=Elementaries(_lib.Z3_mk_finite_set_map)):
  r = _elems.f(a0, a1, a2)
  _elems.Check(a0)
  return r

def Z3_mk_finite_set_filter(a0, a1, a2, _elems=Elementaries(_lib.Z3_mk_finite_set_filter)):
  r = _elems.f(a0, a1, a2)
  _elems.Check(a0)
  return r

def Z3_mk_finite_set_range(a0, a1, a2, _elems=Elementaries(_lib.Z3_mk_finite_set_range)):
  r = _elems.f(a0, a1, a2)
  _elems.Check(a0)
  return r
...
def Z3_mk_seq_replace_all(a0, a1, a2, a3, _elems=Elementaries(_lib.Z3_mk_seq_replace_all)):
  r = _elems.f(a0, a1, a2, a3)
  _elems.Check(a0)
  return r

def Z3_mk_seq_replace_re(a0, a1, a2, a3, _elems=Elementaries(_lib.Z3_mk_seq_replace_re)):
  r = _elems.f(a0, a1, a2, a3)
  _elems.Check(a0)
  return r

def Z3_mk_seq_replace_re_all(a0, a1, a2, a3, _elems=Elementaries(_lib.Z3_mk_seq_replace_re_all)):
  r = _elems.f(a0, a1, a2, a3)
  _elems.Check(a0)
  return r
...
def Z3_optimize_translate(a0, a1, a2, _elems=Elementaries(_lib.Z3_optimize_translate)):
  r = _elems.f(a0, a1, a2)
  _elems.Check(a0)
  return r
...
def Z3_fpa_is_numeral(a0, a1, _elems=Elementaries(_lib.Z3_fpa_is_numeral)):
  r = _elems.f(a0, a1)
  _elems.Check(a0)
  return r
